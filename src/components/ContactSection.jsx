import { ContactSVG1, ContactSVG2 } from "../assets/svg/svg";
import Input, { Lavel } from "./Email";
            ...
            <div className=" rounded-lg bg-white px-8 py-10 shadow-testimonial dark:bg-dark-2 dark:shadow-none sm:px-10 sm:py-12 md:p-[60px] lg:p-10 lg:px-10 lg:py-12 2xl:p-[60px]">
              ...
              <form>
                <div className="mb-[22px]">
                  <Lavel LabelName="Full Name*" HTMLfor="fullname" />
                  <Input Text="text" Name="name" Placeholder="Adam Gelius" />
                </div>
                <div className="mb-[22px]">
                  <Lavel LabelName="Email*" HTMLfor="email" />
                  <Input
                    Text="email"
                    Name="email"
                ...
                <div className="mb-[22px]">
                  <Lavel LabelName="Phone*" HTMLfor="phone" />
                  <Input
                    Text="text"
                    Name="phone"
                ...
                <div className="mb-[30px]">
                  <Lavel LabelName="Message*" HTMLfor="message" />
                  <textarea
                    name="message"
                    rows="1"
